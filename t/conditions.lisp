...
(subtest "Conditions, basic auto-generation tests"
  ...
  (is (amqp:amqp-error-type-from-reply-code amqp::+amqp-no-consumers+) 'amqp::amqp-error-no-consumers
      "ERROR-TYPE-FROM-REPLY-CODE should return AMQP-ERROR-NO-CONSUMERS for +AMQP-NO-CONSUMERS+")
  (is-error (amqp-error-type-from-reply-code 0) 'amqp:amqp-unknown-reply-code-error
